...
6. DSS fájlba menti az eredményt
...
Használat:
    python scripts/prcalc_03.py (opcionális: --weights-file --cell-id/--limit-rows --random-seed)
...
"""
 Menti az eredményeket CSV formátumban.
"""
def save_results(result_df, cella_id, output_dir='results', create_dss=True):
    ...
    # DSS fájlok létrehozása (opcionális)
    if create_dss:
